...
This documentation site is separate from the template repository. To install the template, use:

```bash
quarto use template zhaw-lsfm/quarto-thesis
```

View the template repository at: <https://github.com/zhaw-lsfm/quarto-thesis>
:::
